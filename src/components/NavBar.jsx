...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-10 text-white bg-black-700/80 backdrop-blur fixed
    drop-shadow-[0px_7px_5px_rgba(8,145,178,0.1)]">
      <div>
        {/* Logo */}
        {/* <Link to="home" smooth duration={500}>
          <h1 className="text-4xl text-slate-300 font-poppins cursor-pointer hover:text-sky-400 hover:scale-110 duration-200">SSS</h1>
        </Link> */}
      </div>
